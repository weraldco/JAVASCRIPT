...
document.querySelectorAll('.js-add-to-cart')
  .forEach((button) => {
    button.addEventListener('click',() => {
      ...
      const addedCart = document.querySelector(`.added-to-cart-${productId}`);
      ...
      addedCart.classList.add('added-to-cart-change')
      const addTimeout = setTimeout(()=>{
        addedCart.classList.remove('added-to-cart-change')
      },1500)
